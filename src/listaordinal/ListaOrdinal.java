...
public class ListaOrdinal {
    ...
    /**
     * Inserta el producto en la última posición de la lista
     */
    ...
    /**
     * Borra el primer elemento de la lista cuyo producto coincide con el
     * parámetro recibido, si existe.
     */
    public boolean borrar(Producto producto) {
        Nodo actual = inicio;
        Nodo anterior = null;
        while (actual != null && !actual.getProducto().equals(producto)) {
            anterior = actual;
            actual = actual.getSiguiente();
        }
        if (actual != null) {  // producto encontrado. Borrar nodo actual
    ...
    /**
     * Devuelve la primera posición en la que se encuentra el producto,
    ...
    /**
     * Determina si el producto recibido como parámetro existe en la lista.
     */
